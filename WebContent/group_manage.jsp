...
<ol style="font-family: 幼圆; font-size: 1.5em;" class="breadcrumb">
		...
		<button style="font-size: 10px; margin-left: 800px"
			data-toggle="modal" data-target="#myModal">新增分组</button>
	</ol>

	<form>

		标签名：<input type="text" /> </select> &nbsp;&nbsp; <input style="width: 60px"
			type="submit" value="查询" />&nbsp;&nbsp; <input style="width: 80px"
			type="submit" value="更新分组" />
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h3 class="modal-title" id="myModalLabel">添加分组</h3>
						</div>
						...
						<form act="" method="post">
							<div class="modal-body">
								...
								<div class="input-group input-group-lg">
									<span class="input-group-addon" id="sizing-addon1">分组名字：</span> <input
